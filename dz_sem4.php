...
$works = [
	[
        ...
        "description" => "Тут описание работы аналитиком бизнес-процессов тут описание
        работы аналитиком бизнес-процессов тут описание работы аналитиком бизнес-процессов.",
    ],
    [
        "name" => "Руководитель направления по документообороту",
        "dateStart" => "Сентябрь 2016",
        "dateEnd" => "Июль 2022",
        "description" => "Тут описание работы руководителем направления по документообороту тут описание
        работы руководителем направления по документообороту тут описание работы руководителем
        направления по документообороту.",
    ],
    [
        "name" => "Менеджер СМК",
        "dateStart" => "Февраль 2012",
        "dateEnd" => "Сентябрь 2016",
        "description" => "Тут описание работы менеджером СМК тут описание
        работы менеджером СМК тут описание работы руководителем менеджером СМК.",
    ],
];
?>
<!DOCTYPE html>
